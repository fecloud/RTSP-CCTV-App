/*
 * Vendored from the npm package "h264-converter" 0.1.0 (xevojapan/h264-converter, MIT License) --
 * the same library ws-scrcpy's MSE player is built on. Converts raw Annex-B H.264 NAL data into
 * fragmented MP4 and appends it to a <video> element via Media Source Extensions.
 *
 * This project has no JS bundler, so the library's compiled CommonJS dist/*.js files are
 * concatenated here with a small hand-written module-wiring shim in place of require()/exports --
 * the box-building/parsing code itself is unmodified. See dashboard.html for usage
 * (`new VideoConverter(videoEl, fps, 1).appendRawData(...)`).
 */
(function (global) {
    "use strict";
    ...
    // ---- util/nalu-stream-buffer.js ----
    var naluStreamBufferModule = (function (NALU_1) {
        var exports = {};
    ...
    // ---- h264-parser.js ----
    var h264ParserModule = (function (bit_stream_1, debug, NALU_1) {
        var exports = {};
        ...
        return exports;
    })(bitStreamModule, debugModule, naluModule);

    // ---- h264-remuxer.js ----
    var h264RemuxerModule = (function (h264_parser_1, debug, NALU_1) {
        var exports = {};
        var trackId = 1;
        ...
        return exports;
    })(h264ParserModule, debugModule, naluModule);

    // ---- mp4-generator.js ----
    var mp4GeneratorModule = (function () {
        var exports = {};
        var MP4 = (function () {
            function MP4() {
            }
    ...
    // ---- index.js (VideoConverter) ----
    var indexModule = (function (h264_remuxer_1, mp4_generator_1, debug, nalu_stream_buffer_1) {
        var exports = {};
        exports.mimeType = 'video/mp4; codecs="avc1.42E01E"';
        exports.setLogger = debug.setLogger;
        ...
        return exports;
    })(h264RemuxerModule, mp4GeneratorModule, debugModule, naluStreamBufferModule);

    global.VideoConverter = indexModule.default;
    global.H264ConverterMimeType = indexModule.mimeType;
    // Off by default (no-op) unless dashboard.html wires it up -- see startMsePreview().
    // Surfaces the library's own internal logging, e.g. "MSE Error occured while appending
    // buffer" when appendBuffer() throws (QuotaExceededError and friends), which it otherwise
    // silently swallows.
    global.H264ConverterSetLogger = indexModule.setLogger;
})(window);
