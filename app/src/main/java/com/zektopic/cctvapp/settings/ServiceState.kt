...
data class ServiceSettings(
    ...
    val overlayPosition: String = "Top Left",
    val overlaySize: String = "Medium",
    ...
    companion object {
        ...
        fun loadFromPreferences(context: Context): ServiceSettings = ServiceSettings(
            ...
            showSystemInfo = AppPreferences.getShowSystemInfo(context),
            overlayPosition = AppPreferences.getOverlayPosition(context),
            overlaySize = AppPreferences.getOverlaySize(context),
            flashlightEnabled = AppPreferences.getFlashlightEnabled(context),
            nightModeEnabled = AppPreferences.getNightModeEnabled(context),
            autoFocusEnabled = AppPreferences.getAutoFocusEnabled(context),
            ...
            videoFps = AppPreferences.getVideoFps(context),
